...
public interface TransactionService {
    ...
    public void create(BigDecimal value, String description, Date date, TransactionStatus status, Integer categoryId, TransactionType transactionType, Integer accountId);
    ...
    List<AbstractTransaction> searchTransactions(TransactionStatus status, Integer categoryId, CategoryType categoryType, Integer accountId, Integer cardId);
