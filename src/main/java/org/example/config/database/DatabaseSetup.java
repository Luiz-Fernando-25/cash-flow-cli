...
public class DatabaseSetup {
  ...
  public static void initialize() {
    String sql = """
      ...
      FOREIGN KEY (saida_id) REFERENCES transacao(id) ON DELETE CASCADE
      );
      """;
    try (
  ...
  public static void clearDB() {
    String sql = """
      ...
      TRUNCATE TABLE cartaocredito RESTART IDENTITY;
      TRUNCATE TABLE categoria RESTART IDENTITY;
      TRUNCATE TABLE transacao RESTART IDENTITY;
      TRUNCATE TABLE movimentacao RESTART IDENTITY;


      SET REFERENTIAL_INTEGRITY TRUE;

      INSERT INTO categoria (nome, tipo) VALUES ('Transferência', 'MOVIMENTACAO');
      """;
