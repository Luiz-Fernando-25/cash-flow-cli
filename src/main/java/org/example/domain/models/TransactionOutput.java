...
public class TransactionOutput extends AbstractTransaction{
    public TransactionOutput(BigDecimal transactionValue, String description, Date date, TransactionStatus status, TransactionType type, AbstractAccount account) {
